...
```{r}
write.csv(first_sentence, file = here("test-data/first_sentence.csv"))
```
...
write.csv(last_sentence, file = here("test-data/last_sentence.csv"))
```
