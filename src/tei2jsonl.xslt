...
-->
    ...
    -->
    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:stage">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart[1]/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>, "stage": "<xsl:value-of select="normalize-space(.)"/>", "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>

    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:sp/tei:stage">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>,  "speaker": "<xsl:value-of select="normalize-space(../tei:speaker/text())"/>", "stage": "<xsl:value-of select="normalize-space(.)"/>", "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>

    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:sp/tei:speaker/tei:stage">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart[1]/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../../../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>, "speaker_stage": "<xsl:value-of select="normalize-space(.)"/>", "speaker": "<xsl:value-of select="normalize-space(../../tei:speaker/text())"/>", "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>

    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:sp/tei:p/text()[count(preceding-sibling::*)=0]">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart[1]/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../../../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>, "speaker": "<xsl:value-of select="normalize-space(../../tei:speaker/text())"/>", "spoke": "<xsl:value-of select="normalize-space(.)"/>", "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>

    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:sp/tei:p/tei:stage">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart[1]/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../../../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>, "speaker_stage": "<xsl:value-of select="normalize-space(.)"/>", "speaker": "<xsl:value-of select="normalize-space(../../tei:speaker/text())"/>", <xsl:if test="position() != last()">"spoke": "<xsl:value-of select="normalize-space(following-sibling::text())"/>",</xsl:if> "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>

    <xsl:template match="/tei:TEI/tei:text/tei:body/tei:div/tei:div/tei:sp/tei:lg">{"title": "<xsl:value-of select="/tei:TEI/tei:text/tei:front/tei:titlePage/tei:docTitle/tei:titlePart[1]/text()"/>", "year": "<xsl:value-of select="normalize-space(translate(/tei:TEI/tei:text/tei:front/tei:titlePage/tei:byline/text(),'&#xA;',''))"/>", "act": "<xsl:value-of select="../../../../@n"/>", "act_number": <xsl:call-template name="act_counter"/>, "scene": "<xsl:value-of select="../../../@n"/>", "scene_number": <xsl:call-template name="scene_counter"/>, "speaker": "<xsl:value-of select="normalize-space(../tei:speaker/text())"/>", "spoke": "<xsl:call-template name="lg"/>", "index": <xsl:call-template name="scene_index"/> }<xsl:text>&#xa;</xsl:text></xsl:template>
