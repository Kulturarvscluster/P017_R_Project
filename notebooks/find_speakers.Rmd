...
write.csv(all_speakers, file = here("test-data/allspeakers.csv"))

#skal kun bruges, når vi kører ét stykke ad gangen
speakers_by_scene <- allplays %>% 
  count(act, scene, speaker)
speakers_by_scene
write.csv(speakers_by_scene, file = here("test-data/speakers_by_scene.csv"))
```
...
# get column names
colnames(all_speakers)
write.csv(all_speakers, file = here("test-data/allspeakers uden navnevarianter.csv"))
