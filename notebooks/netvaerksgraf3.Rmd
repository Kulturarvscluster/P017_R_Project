...
ggsave(here("graphs", paste(my_file, ".stress.check_overlap.png")))
...
ggraph(layout = 'kk') + # prøv med forskellige layouts
                                 # muligheder: 'stress' 'dh' 'drl' 'fr' 'gem' 'graphopt' 'kk' 'lgl' 
                                 # 'mds''randomly' m.fl.
    scale_edge_colour_manual(values = c("speaking" = "blue", "silent" = "red")) + # bestem farver manuelt
...
# Create a PNG file for the graph (`mypng.png`)
ggsave(here("graphs", paste(my_file, ".kk.check_overlap.png")))
