...
#Skriv til csv
write.csv(my_speakers, file = here(paste("csv/",my_file, ".csv")))
...
Vi kan prøve at tilføje til grafen ovenfor?!
...
my_summary %>%
  ...
  ggsave(here("graphs/plots", paste(my_file, ".hvem_taler_hvem_omtalt.pdf")), width=16, height=9)
...
#Hvorfor virker funktionen ikke?
