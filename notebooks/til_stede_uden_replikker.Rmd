...
play <- read_play_jsonl(here("test-data", "Barselstuen_mod_nc.jsonl"))
...
vi har testet den på Barselstuen, for der ved vi, at vi skal finde Corfitz under sengen i akt 2, scene 2, så den er god nok.
